...
flamegraph() {
    ...
    for stage in $stages; do
        ...
        if [ -s "${results_dir}/${stage}.folded" ]; then
            ./scripts/analysis/flamegraph.pl ${results_dir}/${stage}.folded --inverted > ${pics_dir}/${stage}_withidle.svg
            ...
            ./scripts/analysis/eventchart-pernode.py --pid_file ${results_dir}/pid_to_dockername --comm_filter bgpd vtysh swapper bird -o ${pics_dir}/${stage}_eventchart.png -t "Event Chart (${stage})" -g ${results_dir}/stage_border_ts ${results_dir}/${stage}.perf
            ./scripts/analysis/eventchart-percore.py --comm_filter swapper -o ${pics_dir}/${stage}_percore_eventchart.png -g ${results_dir}/stage_border_ts  ${results_dir}/${stage}.perf
        fi
    done
}
